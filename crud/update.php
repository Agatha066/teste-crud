		...
		<form action="update.php" method="post">
		  <div class="container">
			...
			<select name="fabricante" id="fab">
			  <option value="<?php echo $res['fabricante']; ?>"></option>
			  </select>
			
			<br><label for="categoria"><b>Categoria</b></label>
			<select name="categoria" id="cat">
			  <option value="<?php echo $res['categoria']; ?>"></option>
			</select>
			
			<br><label for="quantidade"><b>Quantidade</b></label>
			<input type="number" name="quantidade" value="<?php echo $res['quantidade']; ?>" required>
